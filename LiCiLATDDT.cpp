...
unsigned int s[16] = {0,5,3,2,5,8,4,8,9,8,2,8,1,1,1,1}; //LAT

int main()
{
	unsigned int z;
	unsigned long int msb=0x00000000, lsb=0x00000000,x1=0x00,x2=0x00,x3=0x00,x4=0x00,s1=0x00,j,i, temp1=0x00;
	unsigned long long int k[2]={0x0000000000000000,0x0000000000000000}, temp=0x00,count1=0, total_count=0,i1,r1,k1=0;
	...
	printf("\nActive S-boxes %x for %d", j, total_count);
}
